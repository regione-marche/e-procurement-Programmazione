...
public class InterventoEntry extends InterventoBaseEntry{
	...
	private String valutazioneResp;
	private String note;
	...
	private List<RisorsaCapitoloBaseEntry> risorseDicapitolo;
	...
	public String getValutazioneResp() {
		return valutazioneResp;
	}
	public void setValutazioneResp(String valutazioneResp) {
	...
	public List<RisorsaCapitoloBaseEntry> getRisorseDicapitolo() {
		return risorseDicapitolo;
	}
	public void setRisorseDicapitolo(
			List<RisorsaCapitoloBaseEntry> risorseDicapitolo) {
		this.risorseDicapitolo = risorseDicapitolo;
	}
