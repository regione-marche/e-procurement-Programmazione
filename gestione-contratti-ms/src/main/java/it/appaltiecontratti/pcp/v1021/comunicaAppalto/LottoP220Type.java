...
import it.appaltiecontratti.pcp.v1021.comunicaAppalto.LottoP20Type;
...
public class LottoP220Type extends LottoP20Type {
  @JsonProperty("datiBase")
  private AllOfLottoP220TypeDatiBase datiBase = null;
  ...
  private AllOfLottoP220TypeDatiBaseDocumenti datiBaseDocumenti = null;

  public LottoP220Type datiBase(AllOfLottoP220TypeDatiBase datiBase) {
  ...
  **/
  ...
  public AllOfLottoP220TypeDatiBase getDatiBase() {
    return datiBase;
  }

  public void setDatiBase(AllOfLottoP220TypeDatiBase datiBase) {
    this.datiBase = datiBase;
  }

  public LottoP220Type datiBaseContratto(DatiBaseContrattoType datiBaseContratto) {
  ...
  **/
  ...
  public LottoP220Type datiBaseAggiuntivi(DatiBaseAggiuntiviType datiBaseAggiuntivi) {
  ...
  **/
  ...
  public LottoP220Type datiBaseAggiudicazione(DatiBaseAggiudicazioneOptionalType datiBaseAggiudicazione) {
  ...
  **/
  ...
  public LottoP220Type datiBaseTerminiInvio(DatiTerminiInvioType datiBaseTerminiInvio) {
  ...
  **/
  ...
  public LottoP220Type datiBaseCPV(DatiBaseCPVType datiBaseCPV) {
  ...
  **/
  ...
  public LottoP220Type datiBaseAccessibilita(DatiBaseAccessibilitaType datiBaseAccessibilita) {
  ...
  **/
  ...
  public LottoP220Type datiBaseDocumenti(AllOfLottoP220TypeDatiBaseDocumenti datiBaseDocumenti) {
  ...
  **/
  @Schema(required = true, description = "")
  public AllOfLottoP220TypeDatiBaseDocumenti getDatiBaseDocumenti() {
    return datiBaseDocumenti;
  }

  public void setDatiBaseDocumenti(AllOfLottoP220TypeDatiBaseDocumenti datiBaseDocumenti) {
    this.datiBaseDocumenti = datiBaseDocumenti;
  }
  ...
  public boolean equals(Object o) {
    ...
    LottoP220Type lottoP220Type = (LottoP220Type) o;
    return Objects.equals(this.datiBase, lottoP220Type.datiBase) &&
        Objects.equals(this.datiBaseContratto, lottoP220Type.datiBaseContratto) &&
        Objects.equals(this.datiBaseAggiuntivi, lottoP220Type.datiBaseAggiuntivi) &&
        Objects.equals(this.datiBaseAggiudicazione, lottoP220Type.datiBaseAggiudicazione) &&
        Objects.equals(this.datiBaseTerminiInvio, lottoP220Type.datiBaseTerminiInvio) &&
        Objects.equals(this.datiBaseCPV, lottoP220Type.datiBaseCPV) &&
        Objects.equals(this.datiBaseAccessibilita, lottoP220Type.datiBaseAccessibilita) &&
        Objects.equals(this.datiBaseDocumenti, lottoP220Type.datiBaseDocumenti) &&
        super.equals(o);
  }
