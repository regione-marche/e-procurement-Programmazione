...
import it.appaltiecontratti.pcp.v1021.comunicaAppalto.AppaltoP72Type;
import it.appaltiecontratti.pcp.v1021.comunicaAppalto.LottoP72Type;
...
public class AnacFormP72Type extends AnacFormBaseType {
  ...
  private AppaltoP72Type appalto = null;

  @JsonProperty("lotti")
  private List<LottoP72Type> lotti = new ArrayList<>();

  public AnacFormP72Type appalto(AppaltoP72Type appalto) {
  ...
  **/
  ...
  public AppaltoP72Type getAppalto() {
    return appalto;
  }

  public void setAppalto(AppaltoP72Type appalto) {
    this.appalto = appalto;
  }
