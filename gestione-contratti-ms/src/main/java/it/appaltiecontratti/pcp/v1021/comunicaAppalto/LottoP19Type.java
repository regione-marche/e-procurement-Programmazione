...
public class LottoP19Type extends LottoBaseType {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(servizioPubblicoLocale, strumentiElettroniciSpecifici, lavoroOAcquistoPrevistoInProgrammazione, cui, ccnl, tipologiaLavoro, modalitaAcquisizione, opzioniRinnovi, ipotesiCollegamento, categoria, categoriaScorporabile, paritaDiGenereGenerazionale, super.hashCode());
  }
