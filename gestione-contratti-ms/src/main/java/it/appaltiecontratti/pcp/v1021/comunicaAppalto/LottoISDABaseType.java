...
/**
 * Oggetto che riporta i dati del lotto per istituzione dello SDA
 */
@Schema(description = "Oggetto che riporta i dati del lotto per istituzione dello SDA")
...
public class LottoISDABaseType {
  @JsonProperty("lotIdentifier")
  private String lotIdentifier = null;

  public LottoISDABaseType lotIdentifier(String lotIdentifier) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LottoISDABaseType lottoISDABaseType = (LottoISDABaseType) o;
    return Objects.equals(this.lotIdentifier, lottoISDABaseType.lotIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lotIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class LottoISDABaseType {\n");
