...
import it.appaltiecontratti.pcp.v1021.comunicaPostPubblicazione.AvanzamentoType;
import java.util.UUID;
/**
 * Contiene tutti i dati relativi alla scheda di Avanzamenti
 */
@Schema(description = "Contiene tutti i dati relativi alla scheda di Avanzamenti")
...
public class AnacFormSA1Type {
  @JsonProperty("idContratto")
  private UUID idContratto = null;

  @JsonProperty("avanzamento")
  private AvanzamentoType avanzamento = null;

  public AnacFormSA1Type idContratto(UUID idContratto) {
  ...
  **/
  ...
  public AnacFormSA1Type avanzamento(AvanzamentoType avanzamento) {
  ...
  **/
  ...
  public AvanzamentoType getAvanzamento() {
    return avanzamento;
  }

  public void setAvanzamento(AvanzamentoType avanzamento) {
    this.avanzamento = avanzamento;
  }
  ...
  public boolean equals(Object o) {
    ...
    AnacFormSA1Type anacFormSA1Type = (AnacFormSA1Type) o;
    return Objects.equals(this.idContratto, anacFormSA1Type.idContratto) &&
        Objects.equals(this.avanzamento, anacFormSA1Type.avanzamento);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idContratto, avanzamento);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnacFormSA1Type {\n");
