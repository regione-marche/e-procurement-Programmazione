...
public class LottoP23Type {
  ...
  public LottoP23Type lotIdentifier(String lotIdentifier) {
  ...
  **/
  ...
  public LottoP23Type codIstat(CodIstatEnum codIstat) {
  ...
  **/
  ...
  public LottoP23Type lavoroOAcquistoPrevistoInProgrammazione(Boolean lavoroOAcquistoPrevistoInProgrammazione) {
  ...
  **/
  ...
  public LottoP23Type cui(String cui) {
    this.cui = cui;
    return this;
  }
  ...
  **/
  ...
  public LottoP23Type afferenteInvestimentiPNRR(Boolean afferenteInvestimentiPNRR) {
  ...
  **/
  ...
  public LottoP23Type acquisizioneCup(Boolean acquisizioneCup) {
  ...
  **/
  ...
  public LottoP23Type cupLotto(List<String> cupLotto) {
    this.cupLotto = cupLotto;
    return this;
  }

  public LottoP23Type addCupLottoItem(String cupLottoItem) {
  ...
  **/
  ...
  public LottoP23Type contrattiDisposizioniParticolari(ContrattiDisposizioniParticolariEnum contrattiDisposizioniParticolari) {
  ...
  **/
  ...
  public LottoP23Type motivoEsclusioneOrdinarioSpeciale(MotivoEsclusioneOrdinarioSpecialeEnum motivoEsclusioneOrdinarioSpeciale) {
  ...
  **/
  ...
  public LottoP23Type finanziamenti(List<FinanziamentoType> finanziamenti) {
    this.finanziamenti = finanziamenti;
    return this;
  }

  public LottoP23Type addFinanziamentiItem(FinanziamentoType finanziamentiItem) {
  ...
  **/
  ...
  public LottoP23Type quadroEconomicoConcorsiProgettazione(QuadroEconomicoConcorsiProgettazioneType quadroEconomicoConcorsiProgettazione) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LottoP23Type lottoP23Type = (LottoP23Type) o;
    return Objects.equals(this.lotIdentifier, lottoP23Type.lotIdentifier) &&
        Objects.equals(this.codIstat, lottoP23Type.codIstat) &&
        Objects.equals(this.lavoroOAcquistoPrevistoInProgrammazione, lottoP23Type.lavoroOAcquistoPrevistoInProgrammazione) &&
        Objects.equals(this.cui, lottoP23Type.cui) &&
        Objects.equals(this.afferenteInvestimentiPNRR, lottoP23Type.afferenteInvestimentiPNRR) &&
        Objects.equals(this.acquisizioneCup, lottoP23Type.acquisizioneCup) &&
        Objects.equals(this.cupLotto, lottoP23Type.cupLotto) &&
        Objects.equals(this.contrattiDisposizioniParticolari, lottoP23Type.contrattiDisposizioniParticolari) &&
        Objects.equals(this.motivoEsclusioneOrdinarioSpeciale, lottoP23Type.motivoEsclusioneOrdinarioSpeciale) &&
        Objects.equals(this.finanziamenti, lottoP23Type.finanziamenti) &&
        Objects.equals(this.quadroEconomicoConcorsiProgettazione, lottoP23Type.quadroEconomicoConcorsiProgettazione);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lotIdentifier, codIstat, lavoroOAcquistoPrevistoInProgrammazione, cui, afferenteInvestimentiPNRR, acquisizioneCup, cupLotto, contrattiDisposizioniParticolari, motivoEsclusioneOrdinarioSpeciale, finanziamenti, quadroEconomicoConcorsiProgettazione);
  }
