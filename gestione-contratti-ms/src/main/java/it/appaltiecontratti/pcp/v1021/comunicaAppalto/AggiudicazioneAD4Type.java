...
import it.appaltiecontratti.pcp.v1021.comunicaAppalto.DatiBaseAggiudicazioneAppaltoType;
import it.appaltiecontratti.pcp.v1021.comunicaAppalto.DatiBaseCPVType;
import it.appaltiecontratti.pcp.v1021.comunicaAppalto.DatiBaseContrattoADType;
...
import it.appaltiecontratti.pcp.v1021.comunicaAppalto.QuadroEconomicoConcessioniType;
...
public class AggiudicazioneAD4Type {
  ...
  private AllOfAggiudicazioneAD4TypeDatiBaseDocumenti datiBaseDocumenti = null;

  public AggiudicazioneAD4Type lotIdentifier(String lotIdentifier) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type ccnl(String ccnl) {
    this.ccnl = ccnl;
    return this;
  }
  ...
  **/
  ...
  public AggiudicazioneAD4Type categoria(CategoriaEnum categoria) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type categoriaScorporabile(List<CategoriaEnum> categoriaScorporabile) {
    this.categoriaScorporabile = categoriaScorporabile;
    return this;
  }

  public AggiudicazioneAD4Type addCategoriaScorporabileItem(CategoriaEnum categoriaScorporabileItem) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type codIstat(CodIstatEnum codIstat) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type afferenteInvestimentiPNRR(Boolean afferenteInvestimentiPNRR) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type acquisizioneCup(Boolean acquisizioneCup) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type cupLotto(List<String> cupLotto) {
    this.cupLotto = cupLotto;
    return this;
  }

  public AggiudicazioneAD4Type addCupLottoItem(String cupLottoItem) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type paritaDiGenereGenerazionale(ParitaDiGenereGenerazionaleType paritaDiGenereGenerazionale) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type quadroEconomicoStandard(QuadroEconomicoP7Type quadroEconomicoStandard) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type quadroEconomicoConcessioni(QuadroEconomicoConcessioniType quadroEconomicoConcessioni) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type finanziamenti(List<FinanziamentoType> finanziamenti) {
    this.finanziamenti = finanziamenti;
    return this;
  }

  public AggiudicazioneAD4Type addFinanziamentiItem(FinanziamentoType finanziamentiItem) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type partecipanti(List<PartecipanteADType> partecipanti) {
    this.partecipanti = partecipanti;
    return this;
  }

  public AggiudicazioneAD4Type addPartecipantiItem(PartecipanteADType partecipantiItem) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type datiBase(DatiBaseLottoADType datiBase) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type datiBaseCPV(DatiBaseCPVType datiBaseCPV) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type datiBaseContratto(DatiBaseContrattoADType datiBaseContratto) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type datiBaseAggiudicazioneAppalto(DatiBaseAggiudicazioneAppaltoType datiBaseAggiudicazioneAppalto) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type datiBaseAccessibilita(DatiBaseAccessibilitaType datiBaseAccessibilita) {
  ...
  **/
  ...
  public AggiudicazioneAD4Type datiBaseDocumenti(AllOfAggiudicazioneAD4TypeDatiBaseDocumenti datiBaseDocumenti) {
  ...
  **/
  @Schema(description = "")
  public AllOfAggiudicazioneAD4TypeDatiBaseDocumenti getDatiBaseDocumenti() {
    return datiBaseDocumenti;
  }

  public void setDatiBaseDocumenti(AllOfAggiudicazioneAD4TypeDatiBaseDocumenti datiBaseDocumenti) {
    this.datiBaseDocumenti = datiBaseDocumenti;
  }
  ...
  public boolean equals(Object o) {
    ...
    AggiudicazioneAD4Type aggiudicazioneAD4Type = (AggiudicazioneAD4Type) o;
    return Objects.equals(this.lotIdentifier, aggiudicazioneAD4Type.lotIdentifier) &&
        Objects.equals(this.ccnl, aggiudicazioneAD4Type.ccnl) &&
        Objects.equals(this.categoria, aggiudicazioneAD4Type.categoria) &&
        Objects.equals(this.categoriaScorporabile, aggiudicazioneAD4Type.categoriaScorporabile) &&
        Objects.equals(this.codIstat, aggiudicazioneAD4Type.codIstat) &&
        Objects.equals(this.afferenteInvestimentiPNRR, aggiudicazioneAD4Type.afferenteInvestimentiPNRR) &&
        Objects.equals(this.acquisizioneCup, aggiudicazioneAD4Type.acquisizioneCup) &&
        Objects.equals(this.cupLotto, aggiudicazioneAD4Type.cupLotto) &&
        Objects.equals(this.paritaDiGenereGenerazionale, aggiudicazioneAD4Type.paritaDiGenereGenerazionale) &&
        Objects.equals(this.quadroEconomicoStandard, aggiudicazioneAD4Type.quadroEconomicoStandard) &&
        Objects.equals(this.quadroEconomicoConcessioni, aggiudicazioneAD4Type.quadroEconomicoConcessioni) &&
        Objects.equals(this.finanziamenti, aggiudicazioneAD4Type.finanziamenti) &&
        Objects.equals(this.partecipanti, aggiudicazioneAD4Type.partecipanti) &&
        Objects.equals(this.datiBase, aggiudicazioneAD4Type.datiBase) &&
        Objects.equals(this.datiBaseCPV, aggiudicazioneAD4Type.datiBaseCPV) &&
        Objects.equals(this.datiBaseContratto, aggiudicazioneAD4Type.datiBaseContratto) &&
        Objects.equals(this.datiBaseAggiudicazioneAppalto, aggiudicazioneAD4Type.datiBaseAggiudicazioneAppalto) &&
        Objects.equals(this.datiBaseAccessibilita, aggiudicazioneAD4Type.datiBaseAccessibilita) &&
        Objects.equals(this.datiBaseDocumenti, aggiudicazioneAD4Type.datiBaseDocumenti);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lotIdentifier, ccnl, categoria, categoriaScorporabile, codIstat, afferenteInvestimentiPNRR, acquisizioneCup, cupLotto, paritaDiGenereGenerazionale, quadroEconomicoStandard, quadroEconomicoConcessioni, finanziamenti, partecipanti, datiBase, datiBaseCPV, datiBaseContratto, datiBaseAggiudicazioneAppalto, datiBaseAccessibilita, datiBaseDocumenti);
  }
  ...
  public String toString() {
    ...
    sb.append("class AggiudicazioneAD4Type {\n");
