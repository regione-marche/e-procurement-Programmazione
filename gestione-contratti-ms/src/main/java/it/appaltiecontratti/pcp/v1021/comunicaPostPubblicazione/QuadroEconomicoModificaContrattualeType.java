...
public class QuadroEconomicoModificaContrattualeType {
   ...
   * @return impLavori
  **/
  @Schema(required = true, description = "Importo contrattuale componente lavori in € (al netto dell’IVA e degli oneri di sicurezza)")
   ...
   * @return impServizi
  **/
  @Schema(required = true, description = "Importo contrattuale componente servizi in € (al netto dell’IVA e degli oneri di sicurezza)")
   ...
   * @return impForniture
  **/
  @Schema(required = true, description = "Importo contrattuale componente forniture in € (al netto dell’IVA e degli oneri di sicurezza)")
