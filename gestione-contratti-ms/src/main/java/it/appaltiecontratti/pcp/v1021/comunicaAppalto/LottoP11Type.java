...
public class LottoP11Type extends LottoBaseType {
  ...
  **/
  ...
  public LottoP11Type quadroEconomicoStandard(QuadroEconomicoPType quadroEconomicoStandard) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(prestazioniComprese, ripetizioniEConsegneComplementari, strumentiElettroniciSpecifici, ccnl, tipologiaLavoro, modalitaAcquisizione, opzioniRinnovi, ipotesiCollegamento, categoria, categoriaScorporabile, paritaDiGenereGenerazionale, quadroEconomicoStandard, super.hashCode());
  }
