...
public class DatiBaseDurataCSDAType {
  @JsonProperty("dataFine")
  private OffsetDateTime dataFine = null;

  public DatiBaseDurataCSDAType dataFine(OffsetDateTime dataFine) {
   ...
   * @return dataFine
  **/
  @Schema(required = true, description = "La data (stimata) alla quale ha fine l'appalto, l'accordo quadro, il sistema dinamico di acquisizione o il sistema di qualificazione. - nei casi in cui la scheda preveda un eform, corrisponde al campo bt-537 - Duration End Date del TED")
  ...
  public boolean equals(Object o) {
    ...
    DatiBaseDurataCSDAType datiBaseDurataCSDAType = (DatiBaseDurataCSDAType) o;
    return Objects.equals(this.dataFine, datiBaseDurataCSDAType.dataFine);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataFine);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatiBaseDurataCSDAType {\n");
