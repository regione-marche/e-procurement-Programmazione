...
public class LottoP33Type extends LottoP3BaseType {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(afferenteInvestimentiPNRR, categoria, categoriaScorporabile, motivoEsclusioneOrdinarioSpeciale, quadroEconomicoStandard, datiBase, datiBaseCPV, datiBaseContratto, datiBaseAggiudicazione, datiBaseAggiuntivi, datiBaseTerminiInvio, datiBaseDocumenti, super.hashCode());
  }
