...
import it.appaltiecontratti.pcp.v102.comunicaAppalto.LingueEnum;
...
public class DatiBaseDocumentiOptionalType {
  @JsonProperty("url")
  ...
  public DatiBaseDocumentiOptionalType url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return url
  **/
  @Schema(description = "Indirizzo dei documenti di gara - nei casi in cui la scheda preveda un eform, corrisponde al campo bt-15 - Documents Lot Identifier del TED")
  ...
  public DatiBaseDocumentiOptionalType lingue(List<LingueEnum> lingue) {
    this.lingue = lingue;
    return this;
  }

  public DatiBaseDocumentiOptionalType addLingueItem(LingueEnum lingueItem) {
    if (this.lingue == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DatiBaseDocumentiOptionalType datiBaseDocumentiOptionalType = (DatiBaseDocumentiOptionalType) o;
    return Objects.equals(this.url, datiBaseDocumentiOptionalType.url) &&
        Objects.equals(this.lingue, datiBaseDocumentiOptionalType.lingue);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatiBaseDocumentiOptionalType {\n");
