...
/**
 * Oggetto che riporta i dati di aggiudicazione per gli affidamenti diretti.
 */
@Schema(description = "Oggetto che riporta i dati di aggiudicazione per gli affidamenti diretti.")
...
public class AggiudicazioneAD125Type {
  ...
  public AggiudicazioneAD125Type lotIdentifier(String lotIdentifier) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type afferenteInvestimentiPNRR(Boolean afferenteInvestimentiPNRR) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type acquisizioneCup(Boolean acquisizioneCup) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type cupLotto(List<String> cupLotto) {
    this.cupLotto = cupLotto;
    return this;
  }

  public AggiudicazioneAD125Type addCupLottoItem(String cupLottoItem) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type ccnl(String ccnl) {
    this.ccnl = ccnl;
    return this;
  }
  ...
  **/
  ...
  public AggiudicazioneAD125Type categoria(CategoriaEnum categoria) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type categoriaScorporabile(List<CategoriaEnum> categoriaScorporabile) {
    this.categoriaScorporabile = categoriaScorporabile;
    return this;
  }

  public AggiudicazioneAD125Type addCategoriaScorporabileItem(CategoriaEnum categoriaScorporabileItem) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type codIstat(CodIstatEnum codIstat) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type paritaDiGenereGenerazionale(ParitaDiGenereGenerazionaleType paritaDiGenereGenerazionale) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type quadroEconomicoStandard(QuadroEconomicoType quadroEconomicoStandard) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type quadroEconomicoConcessioni(QuadroEconomicoConcessioniType quadroEconomicoConcessioni) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type partecipanti(List<PartecipanteADType> partecipanti) {
    this.partecipanti = partecipanti;
    return this;
  }

  public AggiudicazioneAD125Type addPartecipantiItem(PartecipanteADType partecipantiItem) {
  ...
  **/
  ...
  public AggiudicazioneAD125Type finanziamenti(List<FinanziamentoType> finanziamenti) {
    this.finanziamenti = finanziamenti;
    return this;
  }

  public AggiudicazioneAD125Type addFinanziamentiItem(FinanziamentoType finanziamentiItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AggiudicazioneAD125Type aggiudicazioneAD125Type = (AggiudicazioneAD125Type) o;
    return Objects.equals(this.lotIdentifier, aggiudicazioneAD125Type.lotIdentifier) &&
        Objects.equals(this.afferenteInvestimentiPNRR, aggiudicazioneAD125Type.afferenteInvestimentiPNRR) &&
        Objects.equals(this.acquisizioneCup, aggiudicazioneAD125Type.acquisizioneCup) &&
        Objects.equals(this.cupLotto, aggiudicazioneAD125Type.cupLotto) &&
        Objects.equals(this.ccnl, aggiudicazioneAD125Type.ccnl) &&
        Objects.equals(this.categoria, aggiudicazioneAD125Type.categoria) &&
        Objects.equals(this.categoriaScorporabile, aggiudicazioneAD125Type.categoriaScorporabile) &&
        Objects.equals(this.codIstat, aggiudicazioneAD125Type.codIstat) &&
        Objects.equals(this.paritaDiGenereGenerazionale, aggiudicazioneAD125Type.paritaDiGenereGenerazionale) &&
        Objects.equals(this.quadroEconomicoStandard, aggiudicazioneAD125Type.quadroEconomicoStandard) &&
        Objects.equals(this.quadroEconomicoConcessioni, aggiudicazioneAD125Type.quadroEconomicoConcessioni) &&
        Objects.equals(this.partecipanti, aggiudicazioneAD125Type.partecipanti) &&
        Objects.equals(this.finanziamenti, aggiudicazioneAD125Type.finanziamenti);
  }
  ...
  public String toString() {
    ...
    sb.append("class AggiudicazioneAD125Type {\n");
