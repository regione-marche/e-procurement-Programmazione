...
public class RitardoType {
  ...
  private java.time.OffsetDateTime dataTermine = null;
  ...
  private java.time.OffsetDateTime dataIstanzaRecesso = null;
  ...
  public RitardoType dataTermine(java.time.OffsetDateTime dataTermine) {
  ...
  **/
  ...
  public java.time.OffsetDateTime getDataTermine() {
    return dataTermine;
  }

  public void setDataTermine(java.time.OffsetDateTime dataTermine) {
    this.dataTermine = dataTermine;
  }
  ...
  **/
  ...
  public RitardoType dataIstanzaRecesso(java.time.OffsetDateTime dataIstanzaRecesso) {
  ...
  **/
  ...
  public java.time.OffsetDateTime getDataIstanzaRecesso() {
    return dataIstanzaRecesso;
  }

  public void setDataIstanzaRecesso(java.time.OffsetDateTime dataIstanzaRecesso) {
    this.dataIstanzaRecesso = dataIstanzaRecesso;
  }
