...
/**
 * Oggetto che riporta i dati inerenti l&#x27;affidamento diretto soprasoglia e sottosoglia con pubblicazione su TED - Avviso volontario per la trasparenza ex ante — direttiva sulle concessioni. Articolo 3 bis delle direttive 89/665/CEE e 92/13/CEE
 */
@Schema(description = "Oggetto che riporta i dati inerenti l'affidamento diretto soprasoglia e sottosoglia con pubblicazione su TED - Avviso volontario per la trasparenza ex ante — direttiva sulle concessioni. Articolo 3 bis delle direttive 89/665/CEE e 92/13/CEE")
...
public class AppaltoAD128Type {
  ...
  public AppaltoAD128Type codiceAppalto(String codiceAppalto) {
  ...
  **/
  ...
  public AppaltoAD128Type motivoUrgenza(MotivoUrgenzaEnum motivoUrgenza) {
  ...
  **/
  ...
  public AppaltoAD128Type linkDocumenti(String linkDocumenti) {
  ...
  **/
  ...
  public AppaltoAD128Type opereUrbanizzazioneScomputo(Boolean opereUrbanizzazioneScomputo) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AppaltoAD128Type appaltoAD128Type = (AppaltoAD128Type) o;
    return Objects.equals(this.codiceAppalto, appaltoAD128Type.codiceAppalto) &&
        Objects.equals(this.motivoUrgenza, appaltoAD128Type.motivoUrgenza) &&
        Objects.equals(this.linkDocumenti, appaltoAD128Type.linkDocumenti) &&
        Objects.equals(this.opereUrbanizzazioneScomputo, appaltoAD128Type.opereUrbanizzazioneScomputo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codiceAppalto, motivoUrgenza, linkDocumenti, opereUrbanizzazioneScomputo);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppaltoAD128Type {\n");
