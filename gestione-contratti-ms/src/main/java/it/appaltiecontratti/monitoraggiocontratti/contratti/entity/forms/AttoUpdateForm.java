...
public class AttoUpdateForm {
	...
	@ApiModelProperty(value = "documenti esistenti dell'atto")
	private List<ExistingAttoDocument> existingDocuments;
	@ApiModelProperty(value = "documenti nuovi dell'atto")
	private List<AttoDocument> newDocuments;
	...
	@ApiModelProperty(value = "Allegati da annullare in base al motivoCanc, idAllegato, key01 e numbPubb")
	...
	public List<AttoDocument> getNewDocuments() {
		return newDocuments;
	}

	public void setNewDocuments(List<AttoDocument> newDocuments) {
