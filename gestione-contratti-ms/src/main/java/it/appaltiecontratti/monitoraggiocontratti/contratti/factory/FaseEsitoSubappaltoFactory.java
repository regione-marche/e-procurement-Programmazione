...
public class FaseEsitoSubappaltoFactory extends AbstractFactory {
...
//			}
		...
		if (fase.getMotivoMancatoSub() == null && fase.getDataAuth() == null) {
			ValidateEntry entry = new ValidateEntry("Motivo mancato subappalto/Data autorizzazione subappalto", "Inserire almeno uno dei due", "E");
			risultato.add(entry);
		}
