...
@ApiModel(description = "Contenitore per i dati di un avviso in fase di modifica")
public class AvvisoUpdateForm {
	...
	@ApiModelProperty(value = "Lista documenti pre esistenti dell'avviso (in caso di update)")
