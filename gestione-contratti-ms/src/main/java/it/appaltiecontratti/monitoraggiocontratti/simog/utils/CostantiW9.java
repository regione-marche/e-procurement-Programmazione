package it.appaltiecontratti.monitoraggiocontratti.simog.utils;

public class CostantiW9 {
	...
	/**
	 * Esito negativo verifica regolarita' contributiva ed assicurativa (versione
	 * 2.0.5) Mancata aggiud. def. o pagamento per irregolarita' contrib. ed
	 * assicurativa (art.17c.1 e 2 LR 38/07) (versione 2.1.0)
	 */
	public static final int B03 = 996;
	/**
	 * Esito negativo verifica regolarita' contributiva ed assicurativa (versione
	 * 2.0.5) Mancata aggiud. def. o pagamento per irregolarita' contrib. ed
	 * assicurativa (art.17c.1 e 2 LR 38/07) (versione 2.1.0) public static final
	 * int B03 = 996;
	 */
	 ...
	 * Inadempienze disposizioni sicurezza e regolarita' del lavoro ai sensi
	 * dell’art.23 LR 38/07 (versione 2.1.0)
	 */
	...
	public static final int FASE_VARIAZIONE_AGGIUDICATARI = 21;
