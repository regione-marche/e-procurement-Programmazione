...
import oasis.names.specification.bdndr.schema.xsd.unqualifieddatatypes_1.NameType;
...
@XmlSeeAlso({
    NameType.class,
    oasis.names.specification.bdndr.schema.xsd.unqualifieddatatypes_1.TextType.class
})
