...
import oasis.names.specification.bdndr.schema.xsd.unqualifieddatatypes_1.ValueType;
...
@XmlSeeAlso({
    ValueType.class,
    RateType.class,
    oasis.names.specification.bdndr.schema.xsd.unqualifieddatatypes_1.NumericType.class,
    PercentType.class
})
