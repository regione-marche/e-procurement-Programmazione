...
@Component("io.swagger.client.api.v102.AusaResourceV1Api")
public class AusaResourceV1Api {
     ...
     */
    public InlineResponse400 npaGatewayMsV1ProtectedAusaGetByGet(String xTenantId, String codiceAusa, String codiceFiscale) throws RestClientException {
        return npaGatewayMsV1ProtectedAusaGetByGetWithHttpInfo(xTenantId, codiceAusa, codiceFiscale).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<InlineResponse400> npaGatewayMsV1ProtectedAusaGetByGetWithHttpInfo(String xTenantId, String codiceAusa, String codiceFiscale) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'xTenantId' is set
        if (xTenantId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xTenantId' when calling npaGatewayMsV1ProtectedAusaGetByGet");
        }
        String path = UriComponentsBuilder.fromPath("/npa-gateway-ms/v1/protected/ausa/getBy").build().toUriString();
