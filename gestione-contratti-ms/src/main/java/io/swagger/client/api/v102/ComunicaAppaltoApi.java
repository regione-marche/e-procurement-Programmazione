...
import it.appaltiecontratti.pcp.v102.comunicaAppalto.AckResponse;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.AppaltoListaResponse;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.CancellaAppaltoRequest;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.CancellaAppaltoResponse;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.CigListaResponse;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.ConfermaAppaltoRequest;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.ConsultaAppaltoResponse;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.CreaAppaltoRequest;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.CreaAppaltoResponse;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.DatiAppaltoRequest;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.ErrorResponse;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.ModificaAppaltoResponse;
import java.time.OffsetDateTime;
import java.util.UUID;
import it.appaltiecontratti.pcp.v102.comunicaAppalto.VerificaAppaltoRequest;
...
@Component("io.swagger.client.api.v102.ComunicaAppaltoApi")
public class ComunicaAppaltoApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public AppaltoListaResponse idAppaltoRicerca(String codiceAppalto, String cig, String lotIdentifier, String stato, java.time.OffsetDateTime dataCreazioneDa, java.time.OffsetDateTime dataCreazioneA, Integer page, Integer perPage) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<AppaltoListaResponse> idAppaltoRicercaWithHttpInfo(String codiceAppalto, String cig, String lotIdentifier, String stato, java.time.OffsetDateTime dataCreazioneDa, java.time.OffsetDateTime dataCreazioneA, Integer page, Integer perPage) throws RestClientException {
        Object postBody = null;
