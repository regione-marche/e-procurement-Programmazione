...
import it.appaltiecontratti.pcp.v1021.codeList.ErrorResponse;
import java.time.OffsetDateTime;
import it.appaltiecontratti.pcp.v1021.codeList.TipologicaItemResponse;
import it.appaltiecontratti.pcp.v1021.codeList.TipologicaListaResponse;
import it.appaltiecontratti.pcp.v1021.codeList.TipologicaResponse;
...
@Component("io.swagger.client.api.v1021.CodeListApi")
public class CodeListApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TipologicaResponse idRecuperaTipologica(String idTipologica, OffsetDateTime dataInizio, OffsetDateTime dataFine, Integer page, Integer perPage) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<TipologicaResponse> idRecuperaTipologicaWithHttpInfo(String idTipologica, OffsetDateTime dataInizio, OffsetDateTime dataFine, Integer page, Integer perPage) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'idTipologica' is set
        if (idTipologica == null) {
