...
import { ResponseDTO, ResponseListaDTO, ResultQueryExecutionFormDTO } from "../../model/lib.model";
...
@Component({
    templateUrl: './sdk-risultato-esecuzione-report-predefiniti.component.html',
    styleUrls: ['./sdk-risultato-esecuzione-report-predefiniti.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class SdkRisultatoEsecuzioneReportPredefinitiComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy{

    // #region Variables

    @HostBinding('class') classNames = `sdk-risultato-esecuzione-report-predefiniti-page-section`;
