...
export class MnemonicoModalWidget extends SdkAbstractComponent<any, void, any> implements OnInit, AfterViewInit, OnDestroy {
    ...
    protected onAfterViewInit(): void {
        if (this.mnemonico) {
            ...
            this.requestHelper.begin(factory, this.messagesPanel).subscribe((result: ResponseResult<InfoCampo>) => {
                if (result.data != null) {
                    this.infoCampo = result.data;
    ...
    private get mnemonicoService(): MnemonicoService { return this.injectable(MnemonicoService) }
    ...
    private elaborateConfig(): void {
        if (isObject(this.config)) {
            this.markForCheck(() => {
                ...
                formConfig = this.formBuilderUtilsService.populateForm(this.config, formConfig, true, undefined, this.infoCampo);
    ...
    private infoCampoFactory(tabellatiBaseUrl: string, mnemonico: string) {
        return () => {
            return this.mnemonicoService.getInfoCampo(tabellatiBaseUrl, mnemonico);
        }
    }
