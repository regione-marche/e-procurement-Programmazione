...
@Component({
    templateUrl: `dettaglio-intervento-non-riproposto-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DettaglioInterventoNonRipropostoSectionWidget extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

    // #region Variables

    @HostBinding('class')
    public classNames = `dettaglio-intervento-non-riproposto-section`;
    ...
    private initButtons(): void {      
        if(this.programma.idRicevuto !== undefined && this.programma.idRicevuto !== null){
    ...
    private loadTabellati = (): Observable<IDictionary<Array<ValoreTabellato>>> => {
        return this.tabellatiCacheService.getValoriTabellati(Constants.DETT_INT_NR);
    }
    ...
    public onButtonClick(button: SdkButtonGroupOutput): void {
        ...
        if (isObject(button)) {
            if (isEmpty(button.provider) === false) {
