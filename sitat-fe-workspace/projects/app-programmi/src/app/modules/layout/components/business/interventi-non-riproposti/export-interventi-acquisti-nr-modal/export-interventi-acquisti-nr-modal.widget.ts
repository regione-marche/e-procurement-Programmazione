...
@Component({
    templateUrl: `export-interventi-acquisti-nr-modal.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ExportInterventiAcquistiNrModalWidget extends SdkAbstractComponent<any, void, any> implements OnInit, AfterViewInit, OnDestroy {
    ...
    public interventiAcquistiNrForm: FormGroup;
    ...
    public onButtonClick(button: SdkBasicButtonOutput): void {
        if (button != null && !isEmpty(button.provider)) {
            this.provider.run(button.provider, {
                ...
                interventiAcquistiNrForm: this.interventiAcquistiNrForm,
