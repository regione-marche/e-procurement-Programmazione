...
export interface AdvancedSearchArchivioImpreseProviderArgs extends IDictionary<any> {
...
@Injectable()
export class AdvancedSearchArchivioImpreseProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: AdvancedSearchArchivioImpreseProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('AdvancedSearchArchivioImpreseProvider', args);
        ...
        if (args.buttonCode === 'back-button') {
            ...
            this.store.dispatch(new SdkStoreAction(Constants.SEARCH_FORM_ARCHIVIO_IMPRESE_DISPATCHER, form));
            this.routerService.navigateToPage('lista-archivio-imprese-page');
        }
