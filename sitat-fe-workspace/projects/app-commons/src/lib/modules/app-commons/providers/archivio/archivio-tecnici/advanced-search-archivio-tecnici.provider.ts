...
export interface AdvancedSearchArchivioTecniciProviderArgs extends IDictionary<any> {
...
@Injectable()
export class AdvancedSearchArchivioTecniciProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: AdvancedSearchArchivioTecniciProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('AdvancedSearchArchivioTecniciProvider', args);
        ...
        if (args.buttonCode === 'back-button') {
            ...
            this.store.dispatch(new SdkStoreAction(Constants.SEARCH_FORM_ARCHIVIO_TECNICI_DISPATCHER, form));
