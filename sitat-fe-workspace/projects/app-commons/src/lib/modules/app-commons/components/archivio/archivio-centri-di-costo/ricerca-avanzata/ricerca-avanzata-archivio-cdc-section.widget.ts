...
@Component({
    templateUrl: `ricerca-avanzata-archivio-cdc-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class RicercaAvanzataArchivioCdcSectionWidget extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

    @HostBinding('class') classNames = `ricerca-avanzata-archivio-cdc-section`;
    ...
    private form: RicercaAvanzataArchivioCdcForm;
