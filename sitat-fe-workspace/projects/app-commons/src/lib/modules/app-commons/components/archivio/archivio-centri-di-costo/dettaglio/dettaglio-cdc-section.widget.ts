...
import { DettaglioCdcStoreService } from '../dettaglio-cdc-store.service';


@Component({
    templateUrl: `dettaglio-cdc-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DettaglioCdcSectionWidget extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

    // #region Variables

    @HostBinding('class') classNames = `dettaglio-cdc-section`;
    ...
    protected onInit(): void {
        ...
        this.tabellatiCacheService.getValoriTabellati(Constants.CDC_TABELLATI).subscribe((result: IDictionary<Array<ValoreTabellato>>) => {
            ...
            this.requestHelper.begin(factory, this.messagesPanel).subscribe((result: CentroDiCostoEntry) => {
    ...
    private loadQueryParams(): void {
        ...
        this.dettaglioCdcStore.idCentro = this.idCentro;
    }
    ...
    private elaborateConfig(): void {
        if (isObject(this.config)) {
            this.markForCheck(() => {
                ...
                let customPopulateFunction: CustomParamsFunction = (field: SdkFormBuilderField, restObject: CentroDiCostoEntry) => {
                ...
                formConfig = this.formBuilderUtilsService.populateForm(formConfig, true, customPopulateFunction, this.centroDiCosto);
