...
@Component({
    templateUrl: `esempio-modal.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class EsempioModalWidget extends SdkAbstractComponent<any, void, any> implements OnInit, AfterViewInit, OnDestroy {
        ...
        if (isObject(this.config)) {
            this.markForCheck(() => {
                let formConfig: SdkFormBuilderConfiguration = {
                    fields: get(this.config, 'esempioData.fields')
                };
    ...
    private loadButtons(): void {
        this.buttons = {
            buttons: this.config.esempioData.buttons
        };
