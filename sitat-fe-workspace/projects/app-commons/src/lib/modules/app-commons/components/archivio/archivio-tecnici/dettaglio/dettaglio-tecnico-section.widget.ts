...
import { DettaglioTecnicoStoreService } from '../dettaglio-tecnico-store.service';


@Component({
    templateUrl: `dettaglio-tecnico-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DettaglioTecnicoSectionWidget extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

    // #region Variables

    @HostBinding('class') classNames = `dettaglio-tecnico-section`;
    ...
    private loadQueryParams(): void {
        ...
        this.dettaglioTecnicoStore.codice = this.codice;
    }
    ...
    private elaborateConfig(): void {
        if (isObject(this.config)) {
            this.markForCheck(() => {
                ...
                formConfig = this.formBuilderUtilsService.populateForm(formConfig, true, undefined, this.tecnico);
