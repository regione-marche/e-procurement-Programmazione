...
import { WMailDTO, WMailEditPasswordDTO } from '../../../model/amministrazione.model';
...
export interface SdkImpostaPasswordServerPostaProviderArgs extends IDictionary<any> {
...
@Injectable()
export class SdkImpostaPasswordServerPostaProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: SdkImpostaPasswordServerPostaProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('SdkImpostaPasswordServerPostaProviderArgs >>>', args);

        if (args.buttonCode === 'imposta-password-posta') {
            ...
            if (!isEqual(defaultFormBuilderConfig, formBuilderConfig)) {
                ...
                if (valid === true) {
                    ...
                    let form: WMailEditPasswordDTO = this.populateRequest(formBuilderConfig, item);

                    return this.gestioneServerPostaService.impostaPasswordServerPosta(form).pipe(
    ...
    private populateRequest(formBuilderConfig: SdkFormBuilderConfiguration, item: WMailDTO): WMailEditPasswordDTO {
        let request: WMailEditPasswordDTO = this.getDefaultForm(item);
    ...
    private getDefaultForm(item: WMailDTO): WMailEditPasswordDTO {
        return {
            idCfg: item.idCfg
        };
    }

    private elaborateOne(field: SdkFormBuilderField, request: WMailEditPasswordDTO): WMailEditPasswordDTO {
    ...
    private elaborateSection(field: SdkFormBuilderField, request: WMailEditPasswordDTO): WMailEditPasswordDTO {
    ...
    private elaborateGroup(field: SdkFormBuilderField, request: WMailEditPasswordDTO): WMailEditPasswordDTO {
