...
import { SdkListaConfigurazioniDatasource } from './sdk-lista-configurazioni.datasource.service';

@Component({
    templateUrl: `sdk-lista-configurazioni.component.html`
})
export class SdkListaConfigurazioniComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

    // #region Variables

    @HostBinding('class') classNames = `sdk-lista-configurazioni-section`;
    ...
    private searchForm: RicercaConfigurazioniFormDTO;
    private userProfile: UserProfile;
    private buttons: SdkButtonGroupInput;
    private gridConfig: SdkTableConfig;
    private datasource: SdkListaConfigurazioniDatasource;
    ...
    private initPerformers(): void {
        this.performers = {
            dettaglio: (selectedRow: { rowIndex: number, dataItem: SdkTableRowDto }) => {
                ...
                let item: WConfigDTO = tempItem as WConfigDTO;
                this.dettaglioConfigurazione(item);
            }
        }
    }

    private dettaglioConfigurazione(config: WConfigDTO): void {
        this.provider.run('SDK_GESTIONE_CONFIGURAZIONI_LISTA', {
            action: 'DETAIL',
    ...
    private initGrid(): void {
        ...
        this.datasource = this.factory.create(SdkListaConfigurazioniDatasource, {
