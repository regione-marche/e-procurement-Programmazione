...
@Component({
  templateUrl: './sdk-ricerca-tabellati.component.html'
})
export class SdkRicercaTabellatiComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

  // #region Variables

  @HostBinding('class') classNames = `sdk-ricerca-tabellati-section`;
  ...
  private form: RicercaTabellatiFormDTO;
