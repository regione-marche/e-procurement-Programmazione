...
@Component({
  templateUrl: './sdk-imposta-password-posta.component.html'
})
export class SdkImpostaPasswordPostaComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

  // #region Variables

  @HostBinding('class') classNames = `sdk-imposta-password-posta-section`;
