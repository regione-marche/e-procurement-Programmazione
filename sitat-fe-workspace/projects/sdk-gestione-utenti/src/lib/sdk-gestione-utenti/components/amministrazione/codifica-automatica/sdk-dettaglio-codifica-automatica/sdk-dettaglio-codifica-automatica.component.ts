...
@Component({
  templateUrl: './sdk-dettaglio-codifica-automatica.component.html'
})
export class SdkDettaglioCodificaAutomaticaComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

  // #region Variables

  @HostBinding('class') classNames = `sdk-dettaglio-codifica-automatica-section`;
