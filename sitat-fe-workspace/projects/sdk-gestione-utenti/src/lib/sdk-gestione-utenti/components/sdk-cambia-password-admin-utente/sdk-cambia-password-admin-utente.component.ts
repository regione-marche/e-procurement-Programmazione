...
@Component({
  templateUrl: './sdk-cambia-password-admin-utente.component.html'
})
export class SdkCambiaPasswordAdminUtenteComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

  // #region Variables

  @HostBinding('class') classNames = `sdk-cambia-password-admin-utente-section`;
