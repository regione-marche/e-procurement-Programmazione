...
export class SdkListaModelliPredispostiDatasource extends SdkTableDatasource {
    ...
    private getModelli(searchForm: RicercaModelliForm, state: SdkTableState): Observable<ResponseListaUtentiDTO<Array<UserDTO>>> {
        return this.gestioneModelliService.getListaModelliPredisposti(searchForm, state);
    }
