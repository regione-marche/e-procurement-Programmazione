...
export class FaseEsitoSubappaltoService extends SdkBaseService implements BaseFaseService {
    ...
    public getFase(codGara: string, codLotto: string, progressivo: string): Observable<FaseSubappaltoEntry> {
        ...
        return this.restHelper.get<ResponseResult<FaseSubappaltoEntry>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/getFaseEsitoSubappalto`, params)
            .pipe(
    ...
    public insertFase(request: FaseSubappaltoInsertForm): Observable<any> {
        return this.restHelper.post<ResponseResult<any>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/insertFaseEsitoSubappalto`, request);
    }

    public updateFase(request: FaseSubappaltoInsertForm): Observable<any> {
        return this.restHelper.put<ResponseResult<any>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/updateFaseEsitoSubappalto`, request);
    }
    ...
    public deleteFase(fase: FaseEntry): Observable<any> {
        ...
        return this.restHelper.delete<ResponseResult<any>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/deleteFaseEsitoSubappalto`, null, params);
    }
    ...
    public getDatiInizializzazione(codGara: string, codLotto: string): Observable<InizFaseSubappaltoEntry> {
        ...
        return this.restHelper.get<ResponseResult<InizFaseSubappaltoEntry>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/getInizFaseEsitoSubappalto`, params)
            .pipe(
