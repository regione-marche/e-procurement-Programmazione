...
export class FaseSubappaltoService extends SdkBaseService implements BaseFaseService {
    ...
    public getFase(codGara: string, codLotto: string, progressivo: string): Observable<FaseSubappaltoEntry> {
        ...
        return this.restHelper.get<ResponseResult<FaseSubappaltoEntry>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/getFaseSubappalto`, params)
            .pipe(
    ...
    public insertFase(request: FaseSubappaltoInsertForm): Observable<any> {
        return this.restHelper.post<ResponseResult<any>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/insertFaseSubappalto`, request);
    }

    public updateFase(request: FaseSubappaltoInsertForm): Observable<any> {
        return this.restHelper.put<ResponseResult<any>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/updateFaseSubappalto`, request);
    }
    ...
    public deleteFase(fase: FaseEntry): Observable<any> {
        ...
        return this.restHelper.delete<ResponseResult<any>>(`${environment.GESTIONE_CONTRATTI_BASE_URL}/deleteFaseSubappalto`, null, params);
    }
