...
@Component({
    templateUrl: `modifica-fase-iniz-sottoscrizione-contratto-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModificaFaseInizSottoscrizioneContrattoSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class') classNames = `modifica-fase-iniz-sottoscrizione-contratto-section`;
