...
@Component({
    templateUrl: `dettaglio-fase-inadempienze-sicurezza-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DettaglioFaseInadempienzeSicurezzaSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `dettaglio-fase-inadempienze-sicurezza-section`;
