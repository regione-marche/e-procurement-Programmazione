...
import { cloneDeep, get, isEmpty, isObject, isString, set, toString, map as mapArray } from 'lodash-es';
...
@Component({
    templateUrl: `dettaglio-fase-richiesta-subappalto-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DettaglioFaseRichiestaSubappaltoSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `dettaglio-fase-richiesta-subappalto-section`;
