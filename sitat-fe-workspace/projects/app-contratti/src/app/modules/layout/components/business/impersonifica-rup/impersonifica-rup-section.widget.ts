...
@Component({
    templateUrl: `impersonifica-rup-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ImpersonificaSectionWidget extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

    // #region Variables

    @HostBinding('class') classNames = `impersonifica-rup-section`;
    ...
    private loadForm(): void {
        ...
        formConfig = this.formBuilderUtilsService.populateForm(formConfig, true, customPopulateFunction, undefined, undefined, infoBox);
