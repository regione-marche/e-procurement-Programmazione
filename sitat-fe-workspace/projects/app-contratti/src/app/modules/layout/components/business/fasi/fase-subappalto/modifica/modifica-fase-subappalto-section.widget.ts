...
@Component({
    templateUrl: `modifica-fase-subappalto-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModificaFaseSubappaltoSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `modifica-fase-subappalto-section`;
    ...
    protected get faseSubappaltoService(): FaseSubappaltoService {
        return this.injectable(FaseSubappaltoService);
    }
