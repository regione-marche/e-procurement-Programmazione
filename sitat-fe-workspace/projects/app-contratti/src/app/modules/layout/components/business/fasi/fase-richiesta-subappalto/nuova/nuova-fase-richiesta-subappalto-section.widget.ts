...
import { SdkAutocompleteItem, SdkComboBoxItem, SdkFormBuilderField, SdkFormBuilderInput, SdkModalOutput } from '@maggioli/sdk-controls';
...
@Component({
    templateUrl: `nuova-fase-richiesta-subappalto-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class NuovaFaseRichiestaSubappaltoSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `nuova-fase-richiesta-subappalto-section`;
    ...
    public manageModalOutput(_item: SdkModalOutput<any>): void {
        if (isObject(_item) && _item.code === 'modal') {
            if (isObject(_item.data)) {                
                ...
                const listaCpv: Array<SdkComboBoxItem> = mapArray(this.fase.listaCpv, (one: CPVSecondario) => {
                    const item: SdkComboBoxItem = {
