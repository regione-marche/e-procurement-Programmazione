...
@Component({
    templateUrl: `modifica-fase-recesso-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModificaFaseRecessoSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `modifica-fase-recesso-section`;
    ...
    private get faseRecessoService(): FaseRecessoService {
        return this.injectable(FaseRecessoService);
    }
