...
@Component({
    templateUrl: `nuova-fase-inidoneita-tecnico-prof-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class NuovaFaseInidoneitaTecnicoProfSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `nuova-fase-inidoneita-tecnico-prof-section`;
