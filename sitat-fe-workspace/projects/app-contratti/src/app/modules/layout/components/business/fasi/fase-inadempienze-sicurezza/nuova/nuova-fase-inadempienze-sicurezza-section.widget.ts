...
@Component({
    templateUrl: `nuova-fase-inadempienze-sicurezza-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class NuovaFaseInadempienzeSicurezzaSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `nuova-fase-inadempienze-sicurezza-section`;
