...
import { cloneDeep, each, find, get, has, isEmpty, isEqual, isObject, isString, remove, set, sum, toString } from "lodash-es";
...
@Component({
    templateUrl: `modifica-delega-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ModificaDelegaSectionWidget extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {
    // #region Variables

    @HostBinding("class") classNames = `modifica-delega-section`;
    ...
    private executeButtonProvider(button: SdkButtonGroupOutput): void {
        ...
        if (button.code === "back-to-dettaglio-delega" && isEqual(this.defaultFormBuilderConfig, this.formBuilderConfig) === false) {
    ...
    private loadForm(): void {
        ...
        formConfig = this.formBuilderUtilsService.populateForm(formConfig, true, customPopulateFunction, this.delega, {}, infoBox);
