...
@Component({
    templateUrl: `modifica-fase-inidoneita-contributiva-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModificaFaseInidoneitaContributivaSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `modifica-fase-inidoneita-contributiva-section`;
