...
@Component({
    // to avoid NG0912: Component ID generation collision detected with grafica-form-group-section (do not use this selector!)
    selector: 'grafica-document-panel-section-local',
    templateUrl: `grafica-document-panel-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class GraficaDocumentPanelSectionWidget extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

    // #region Variables

    @HostBinding('class') classNames = `grafica-document-panel-section`;
