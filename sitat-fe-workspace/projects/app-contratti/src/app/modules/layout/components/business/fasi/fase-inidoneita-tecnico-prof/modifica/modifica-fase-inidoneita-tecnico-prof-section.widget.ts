...
@Component({
    templateUrl: `modifica-fase-inidoneita-tecnico-prof-section.widget.html`,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModificaFaseInidoneitaTecnicoProfSectionWidget extends FaseAbstractSectionWidget {

    // #region Variables

    @HostBinding('class')
    public classNames = `modifica-fase-inidoneita-tecnico-prof-section`;
    ...
    private get faseInidoneitaTecnicoProfService(): FaseInidoneitaTecnicoProfService {
        return this.injectable(FaseInidoneitaTecnicoProfService);
    }
