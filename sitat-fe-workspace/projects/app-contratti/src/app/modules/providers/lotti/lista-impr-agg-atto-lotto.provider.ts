...
export interface ListaImpreseAggiudicatarieAttoLottoProviderArgs extends IDictionary<any> {
...
export class ListaImpreseAggiudicatarieAttoLottoProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: ListaImpreseAggiudicatarieAttoLottoProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('ListaImpreseAggiudicatarieAttoLottoProviderArgs >>>', args);
    ...
    private deleteImpresaAggiudicataria(args: ListaImpreseAggiudicatarieAttoLottoProviderArgs): Observable<IDictionary<any>> {
    ...
    private dettaglioImpresaAggiudicataria(args: ListaImpreseAggiudicatarieAttoLottoProviderArgs): Observable<IDictionary<any>> {
        ...
        if (isObject(args.impresa)) {
            ...
            this.routerService.navigateToPage('dettaglio-impr-agg-atto-lotto-page', params);
        }
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
    ...
    private updateImpresa(args: ListaImpreseAggiudicatarieAttoLottoProviderArgs): Observable<IDictionary<any>> {
        ...
        if (isObject(args.impresa)) {
            ...
            this.routerService.navigateToPage('modifica-impr-agg-atto-lotto-page', params);
        }
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
    ...
    private listaImpreseAggiudicatarie(args: ListaImpreseAggiudicatarieAttoLottoProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('lista-impr-agg-atto-lotto-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private nuovaImpresa(args: ListaImpreseAggiudicatarieAttoLottoProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('nuova-impr-agg-atto-lotto-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private saveImpresa(args: ListaImpreseAggiudicatarieAttoLottoProviderArgs): Observable<IDictionary<any>> {
