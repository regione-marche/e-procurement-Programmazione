...
export interface IncarichiProfessionaliFaseInizialeProviderArgs extends IDictionary<any> {
...
export class IncarichiProfessionaliFaseInizialeProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: IncarichiProfessionaliFaseInizialeProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('IncarichiProfessionaliFaseInizialeProviderArgs >>>', args);
    ...
    private dettaglioIncarichiProfessionali(args: IncarichiProfessionaliFaseInizialeProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('dettaglio-inc-prof-fase-ini-page', params);
    ...
    private goToUpdateIncarichiProfessionali(args: IncarichiProfessionaliFaseInizialeProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('modifica-inc-prof-fase-ini-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private saveIncarichi(args: IncarichiProfessionaliFaseInizialeProviderArgs): Observable<any> {
