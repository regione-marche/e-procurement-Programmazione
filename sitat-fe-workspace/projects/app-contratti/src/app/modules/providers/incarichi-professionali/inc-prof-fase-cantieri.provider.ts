...
export interface IncarichiProfessionaliFaseCantieriProviderArgs extends IDictionary<any> {
...
export class IncarichiProfessionaliFaseCantieriProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: IncarichiProfessionaliFaseCantieriProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('IncarichiProfessionaliFaseCantieriProviderArgs >>>', args);
    ...
    private dettaglioIncarichiProfessionali(args: IncarichiProfessionaliFaseCantieriProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('dettaglio-inc-prof-fase-cantieri-page', params);
    ...
    private goToUpdateIncarichiProfessionali(args: IncarichiProfessionaliFaseCantieriProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('modifica-inc-prof-fase-cantieri-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private saveIncarichi(args: IncarichiProfessionaliFaseCantieriProviderArgs): Observable<any> {
