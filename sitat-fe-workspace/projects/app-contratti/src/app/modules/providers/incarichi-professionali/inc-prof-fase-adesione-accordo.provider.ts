...
export interface IncarichiProfessionaliFaseAdesioneAccordoProviderArgs extends IDictionary<any> {
...
export class IncarichiProfessionaliFaseAdesioneAccordoProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: IncarichiProfessionaliFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('IncarichiProfessionaliFaseAdesioneAccordoProviderArgs >>>', args);
    ...
    private dettaglioIncarichiProfessionali(args: IncarichiProfessionaliFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('dettaglio-inc-prof-fase-adesione-accordo-page', params);
    ...
    private goToUpdateIncarichiProfessionali(args: IncarichiProfessionaliFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('modifica-inc-prof-fase-adesione-accordo-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private saveIncarichi(args: IncarichiProfessionaliFaseAdesioneAccordoProviderArgs): Observable<any> {
