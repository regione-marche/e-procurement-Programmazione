...
export interface FinanziamentiFaseAdesioneAccordoProviderArgs extends IDictionary<any> {
...
export class FinanziamentiFaseAdesioneAccordoProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: FinanziamentiFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('FinanziamentiFaseAdesioneAccordoProviderArgs >>>', args);
    ...
    private dettaglioFinanziamenti(args: FinanziamentiFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('dettaglio-finanziamenti-fase-adesione-accordo-page', params);
    ...
    private goToupdateFinanziamenti(args: FinanziamentiFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('modifica-finanziamenti-fase-adesione-accordo-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private saveFinanziamenti(args: FinanziamentiFaseAdesioneAccordoProviderArgs): Observable<any> {
