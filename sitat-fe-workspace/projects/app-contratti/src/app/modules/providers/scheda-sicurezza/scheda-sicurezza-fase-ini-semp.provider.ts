...
export interface SchedaSicurezzaFaseInizialeSempProviderArgs extends IDictionary<any> {
...
export class SchedaSicurezzaFaseInizialeSempProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: SchedaSicurezzaFaseInizialeSempProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('SchedaSicurezzaFaseInizialeSempProviderArgs >>>', args);
    ...
    private deleteSchedaSicurezza(args: SchedaSicurezzaFaseInizialeSempProviderArgs): Observable<IDictionary<any>> {
    ...
    private dettaglioSchedaSicurezza(args: SchedaSicurezzaFaseInizialeSempProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('dettaglio-scheda-sicurezza-fase-ini-semp-page', params);
    ...
    private goToUpdateSchedaSicurezza(args: SchedaSicurezzaFaseInizialeSempProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('modifica-scheda-sicurezza-fase-ini-semp-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private goToNuovaSchedaSicurezza(args: SchedaSicurezzaFaseInizialeSempProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('nuova-scheda-sicurezza-fase-ini-semp-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private saveSchedaSicurezza(args: SchedaSicurezzaFaseInizialeSempProviderArgs): Observable<any> {
