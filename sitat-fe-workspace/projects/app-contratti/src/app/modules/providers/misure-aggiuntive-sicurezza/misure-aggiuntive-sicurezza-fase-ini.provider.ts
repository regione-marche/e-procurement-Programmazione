...
export interface MisureAggiuntiveSicurezzaFaseInizialeProviderArgs extends IDictionary<any> {
...
export class MisureAggiuntiveSicurezzaFaseInizialeProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: MisureAggiuntiveSicurezzaFaseInizialeProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('MisureAggiuntiveSicurezzaFaseInizialeProviderArgs >>>', args);
    ...
    private deleteMisureAggiuntiveSicurezza(args: MisureAggiuntiveSicurezzaFaseInizialeProviderArgs): Observable<IDictionary<any>> {
    ...
    private dettaglioMisureAggiuntiveSicurezza(args: MisureAggiuntiveSicurezzaFaseInizialeProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('dettaglio-mis-agg-sic-fase-ini-page', params);
    ...
    private goToUpdateMisureAggiuntiveSicurezza(args: MisureAggiuntiveSicurezzaFaseInizialeProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('modifica-mis-agg-sic-fase-ini-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private goToNuoveMisureAggiuntiveSicurezza(args: MisureAggiuntiveSicurezzaFaseInizialeProviderArgs): Observable<IDictionary<any>> {
        let params: IDictionary<any> = {
            codGara: args.codGara,
            codLotto: args.codLotto,
            codiceFase: args.codiceFase,
        ...
        this.routerService.navigateToPage('nuove-mis-agg-sic-fase-ini-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private saveMisureAggiuntiveSicurezza(args: MisureAggiuntiveSicurezzaFaseInizialeProviderArgs): Observable<any> {
