...
export interface ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs extends IDictionary<any> {
...
export class ListaImpreseAggiudicatarieFaseAggiudicazioneSempProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs >>>', args);
    ...
    private deleteImpresaAggiudicataria(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
    ...
    private dettaglioImpresaAggiudicataria(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
        ...
        if (isObject(args.impresa)) {
            ...
            this.routerService.navigateToPage('dettaglio-impr-agg-fase-agg-semp-page', params);
        }
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
    ...
    private updateImpresa(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
        ...
        if (isObject(args.impresa)) {
            ...
            this.routerService.navigateToPage('modifica-impr-agg-fase-agg-semp-page', params);
        }
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
    ...
    private listaImpreseAggiudicatarie(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('lista-impr-agg-fase-agg-semp-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private nuovaImpresa(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
        ...
        return this.requestHelper.begin(factory, args.messagesPanel)
            .pipe(
                map((result: Array<FaseImpresaEntry>) => {
                    ...
                    if (size(result) > 0) {
                        this.routerService.navigateToPage('import-impr-agg-fase-agg-semp-page', params);
                    } else {
                        this.routerService.navigateToPage('nuova-impr-agg-fase-agg-semp-page', params);
                    }
    ...
    private importImpresa(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
    ...
    private saveImpresa(args: ListaImpreseAggiudicatarieFaseAggiudicazioneSempProviderArgs): Observable<IDictionary<any>> {
