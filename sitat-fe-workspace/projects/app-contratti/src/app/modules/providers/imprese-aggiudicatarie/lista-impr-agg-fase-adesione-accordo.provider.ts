...
export interface ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs extends IDictionary<any> {
...
export class ListaImpreseAggiudicatarieFaseAdesioneAccordoProvider extends SdkBaseService implements SdkProvider {

    constructor(inj: Injector) {
        super(inj);
    }

    public run(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        this.logger.debug('ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs >>>', args);
    ...
    private deleteImpresaAggiudicataria(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
    ...
    private dettaglioImpresaAggiudicataria(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        ...
        if (isObject(args.impresa)) {
            ...
            this.routerService.navigateToPage('dettaglio-impr-agg-fase-adesione-accordo-page', params);
        }
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
    ...
    private updateImpresa(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        ...
        if (isObject(args.impresa)) {
            ...
            this.routerService.navigateToPage('modifica-impr-agg-fase-adesione-accordo-page', params);
        }
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
    ...
    private listaImpreseAggiudicatarie(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        ...
        this.routerService.navigateToPage('lista-impr-agg-fase-adesione-accordo-page', params);
        return new Observable((ob: Observer<IDictionary<any>>) => {
            ob.next(undefined);
            ob.complete();
        });
    ...
    private nuovaImpresa(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
        ...
        return this.requestHelper.begin(factory, args.messagesPanel)
            .pipe(
                map((result: Array<FaseImpresaEntry>) => {
                    ...
                    if (size(result) > 0) {
                        this.routerService.navigateToPage('import-impr-agg-fase-adesione-accordo-page', params);
                    } else {
                        this.routerService.navigateToPage('nuova-impr-agg-fase-adesione-accordo-page', params);
                    }
    ...
    private importImpresa(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
    ...
    private saveImpresa(args: ListaImpreseAggiudicatarieFaseAdesioneAccordoProviderArgs): Observable<IDictionary<any>> {
