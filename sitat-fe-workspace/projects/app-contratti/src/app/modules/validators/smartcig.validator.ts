...
export class SmartCigValidator extends SdkBaseService implements SdkValidatorServiceFunction {
    ...
    public run(messages: Array<SdkValidationMessage>): SdkValidatorFunction<any> {
        return (input: SdkValidatorInput<any>): SdkValidatorOutput => {
            ...
            const valid: boolean = isEmpty(data) || this.isSmartCigValido(data);
            return {
                valid,
