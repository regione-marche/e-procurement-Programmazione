...
public class ResponseRup extends BaseResponse implements Serializable{
	...
	@ApiModelProperty(value="Dati del RUP")
	private RupEntry data;
	...
	public RupEntry getData() {
		return data;
	}

	public void setData(RupEntry entry) {
		this.data = entry;
	}
}
