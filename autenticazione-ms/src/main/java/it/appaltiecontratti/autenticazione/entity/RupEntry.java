...
/**
 * Entry per un singolo tecnico/rup
 *
...
public class RupEntry implements Serializable {
    ...
    private static final long serialVersionUID = 4581196383787251409L;
    ...
    public void setNumCivico(String numCivico) { this.numCivico = numCivico; }
    ...
    public String getCodIstat() { return codIstat; }
    public void setCodIstat(String codIstat) { this.codIstat = codIstat; }
