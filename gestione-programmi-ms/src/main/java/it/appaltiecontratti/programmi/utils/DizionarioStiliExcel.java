...
public class DizionarioStiliExcel {
	  ...
	  private static final String DEFAULT_FONT_NAME = HSSFFont.FONT_ARIAL;
	    ...
	    this.mappaStili.put(Integer.valueOf(CELLA_INTESTAZIONE), style);
	    ...
	    style.setWrapText(true);
	    this.setBorder(style);
	    this.mappaStili.put(Integer.valueOf(CELLA_INTESTAZIONE_ARANCIONE), style);
	    ...
	    this.setBorder(style);
	    style.setWrapText(true);
	    this.mappaStili.put(Integer.valueOf(CELLA_NASCOSTA), style);
	    ...
	    style.setFillPattern(FillPatternType.SOLID_FOREGROUND);
	    this.setBorder(style);
	    this.mappaStili.put(Integer.valueOf(CELLA_SEPARATRICE), style);
	    ...
	    style.setFillPattern(FillPatternType.SOLID_FOREGROUND);
	    this.setBorder(style);
	    this.mappaStili.put(Integer.valueOf(CELLA_SEPARATRICE_ARANCIONE), style);
			...
			style.setAlignment(HorizontalAlignment.CENTER);
			this.setBorder(style);
			this.mappaStili.put(Integer.valueOf(INTERO_ALIGN_CENTER_FRAMED), style);
		  ...
		  style.setVerticalAlignment(VerticalAlignment.CENTER);
			...
			style.setAlignment(HorizontalAlignment.CENTER);
			this.setBorder(style);
			this.mappaStili.put(Integer.valueOf(STRINGA_ALIGN_CENTER_FRAMED), style);
		  ...
		  style.setVerticalAlignment(VerticalAlignment.CENTER);
			...
			style.setAlignment(HorizontalAlignment.CENTER);
			this.setBorder(style);
			this.mappaStili.put(Integer.valueOf(DECIMALE2_ALIGN_CENTER_FRAMED), style);
	        ...
	        this.mappaStili.put(Integer.valueOf(DECIMALE4_ALIGN_RIGHT), style);
		  ...
		  style.setVerticalAlignment(VerticalAlignment.CENTER);
			...
			style.setAlignment(HorizontalAlignment.CENTER);
			this.setBorder(style);
			this.mappaStili.put(Integer.valueOf(DATA_ALIGN_CENTER_FRAMED), style);
	        ...
	        style.setAlignment(HorizontalAlignment.CENTER);
	        this.setBorder(style);
	        this.mappaStili.put(Integer.valueOf(STRINGA_ALIGN_CENTER_GENERAL_FORMAT), style);
		      ...
		      for(int horizontalAlign = 0; horizontalAlign <= 2; horizontalAlign++) {
		        for(int boldWeight = 0; boldWeight <= 3; boldWeight++){
		          ...
		          if (indiceFormatoDati <= 2)
			        ...
			        this.mappaStili.put(Integer.valueOf(cellaLocked * (arrayKeyCellStyle[indiceFormatoDati] +
	  ...
	  private void setBorder(CellStyle style) {
		...
		public CellStyle getStileExcel(int idStile){
			return this.mappaStili.get(Integer.valueOf(idStile));
		}
...
//	    font.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);
	   ...
	   * @param wb
	   */
	  private void createFormats(Workbook wb){
