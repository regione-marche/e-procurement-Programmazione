...
public class InterventoPubbEntry implements Serializable {
	/**
	 * UID.
	 */
	...
	@ApiModelProperty(value="Lavoro complesso? (/WSTabelleDiContesto/rest/Tabellati/Valori?cod=SN)", required=true)
	@Size(max=1)
	...
	@ApiModelProperty(value="Finalit� dell'intervento (OBBLIGATORIO se anno = 1)(/WSTabelleDiContesto/rest/Tabellati/Valori?cod=Finalita)")
	@Size(max=5)
	private String finalita;
	
	@ApiModelProperty(value="Svolta verifica conformit� urbanistica? (OBBLIGATORIO se anno = 1)(/WSTabelleDiContesto/rest/Tabellati/Valori?cod=SN)")
	@Size(max=1)
	private String conformitaUrbanistica;
	
	@ApiModelProperty(value="Svolta verifica conformit� vincoli ambientali? (OBBLIGATORIO se anno = 1)(/WSTabelleDiContesto/rest/Tabellati/Valori?cod=SN)")
	@Size(max=1)
	private String conformitaAmbientale;
	
	@ApiModelProperty(value="Stato Progettazione approvata (OBBLIGATORIO se anno = 1)(/WSTabelleDiContesto/rest/Tabellati/Valori?cod=StatoProgettazione)")
	@Size(max=2)
	...
	@ApiModelProperty(value = "Codice AUSA del Soggetto delegato (OBBLIGATORIO se anno = 1)")
	@Size(max=20)
	private String codiceSoggettoDelegato;
	
	@ApiModelProperty(value = "Denominazione del Soggetto delegato (OBBLIGATORIO se anno = 1)")
	@Size(max=160)
	...
	private DatiGeneraliTecnicoPubbEntry rup;
	...
	private Double importoCapitalePrivato;
	...
	public void setRup(DatiGeneraliTecnicoPubbEntry rup) {
		this.rup = rup;
	}

	public DatiGeneraliTecnicoPubbEntry getRup() {
		return rup;
	}
