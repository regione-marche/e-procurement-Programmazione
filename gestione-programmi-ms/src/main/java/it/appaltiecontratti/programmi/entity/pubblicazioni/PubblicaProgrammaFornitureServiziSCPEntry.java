...
public class PubblicaProgrammaFornitureServiziSCPEntry implements Serializable {
	/**
	 * UID.
	 */
	...
	@Size(min=0)
    private List<AcquistoPubbEntry> acquisti = new ArrayList<AcquistoPubbEntry>();

	@ApiModelProperty(value="Lista acquisti non riproposti")
	@Size(min=0)
    private List<AcquistoNonRipropostoPubbEntry> acquistiNonRiproposti = new ArrayList<AcquistoNonRipropostoPubbEntry>();
	...
	public void setAcquisti(List<AcquistoPubbEntry> acquisti) {
		this.acquisti = acquisti;
	}

	public List<AcquistoPubbEntry> getAcquisti() {
		return acquisti;
	}

	public void setAcquistiNonRiproposti(List<AcquistoNonRipropostoPubbEntry> acquistiNonRiproposti) {
		this.acquistiNonRiproposti = acquistiNonRiproposti;
	}

	public List<AcquistoNonRipropostoPubbEntry> getAcquistiNonRiproposti() {
    ...
    public String toString() {
        return "PubblicaProgrammaFornitureServiziEntry{" +
                "codiceSA='" + codiceSA + '\'' +
                ", contri=" + contri +
                ", syscon=" + syscon +
                ", id='" + id + '\'' +
                ", clientId='" + clientId + '\'' +
                ", codiceFiscaleSA='" + codiceFiscaleSA + '\'' +
                ", idUfficio=" + idUfficio +
                ", ufficio='" + ufficio + '\'' +
                ", anno=" + anno +
                ...
                ", titoloAttoApprovazione='" + titoloAttoApprovazione + '\'' +
                ", urlAttoApprovazione='" + urlAttoApprovazione + '\'' +
                ", codiceReferente='" + codiceReferente + '\'' +
                ", referente=" + referente +
                ", acquisti=" + acquisti +
                ", acquistiNonRiproposti=" + acquistiNonRiproposti +
