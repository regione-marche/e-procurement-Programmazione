...
@Injectable()
export class SdkGestioneUtentiGestoreProfiliVisibleProvider extends SdkBaseService implements SdkProvider {
    ...
    public run(args: IDictionary<any>): boolean {
        ...
        if (initRicercaUtenti != null) {
            ...
            return initRicercaUtenti.utenteDelegatoGestioneUtenti == false ||
                (
                    initRicercaUtenti.utenteDelegatoGestioneUtenti == true && initRicercaUtenti.profiliAssociati != null && initRicercaUtenti.profiliAssociati.length > 1
                );
        }
        return false;
    }
