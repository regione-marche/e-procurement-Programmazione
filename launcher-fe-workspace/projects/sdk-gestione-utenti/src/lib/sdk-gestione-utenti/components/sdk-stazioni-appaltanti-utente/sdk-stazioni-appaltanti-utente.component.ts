...
import { InitRicercaUtentiDTO, UfficioIntestatarioDTO, UserDTO } from '../../model/gestione-utenti.model';
...
@Component({
  templateUrl: './sdk-stazioni-appaltanti-utente.component.html',
  styleUrls: ['./sdk-stazioni-appaltanti-utente.component.scss']
})
export class SdkStazioniAppaltantiUtenteComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

  // #region Variables

  @HostBinding('class') classNames = `sdk-stazioni-appaltanti-utente-section`;
  ...
  public stazioniAppaltantiUtente: Array<UfficioIntestatarioDTO>;
  ...
  protected onAfterViewInit(): void {
    this.loadStazioniAppaltantiUtente()
      .pipe(
        map(this.elaborateStazioniAppaltantiUtente),
  ...
  private loadStazioniAppaltantiUtente = (): Observable<ResponseDTO<Array<UfficioIntestatarioDTO>>> => {
  ...
  private elaborateStazioniAppaltantiUtente = (result: ResponseDTO<Array<UfficioIntestatarioDTO>>) => {
    this.stazioniAppaltantiUtente = result.response;
  }

  private elaborateButtons = () => {
    let hasDifferentUfficiIntestatari: boolean = this.initRicercaUtenti.utenteDelegatoGestioneUtenti == true && this.gestioneUtentiService.userHasDifferentUfficiIntestatariThanSessionUser(this.dettaglio.ufficiIntestatari, this.initRicercaUtenti.stazioniAppaltantiAssociate);
