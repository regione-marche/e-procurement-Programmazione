...
@Component({
  templateUrl: './sdk-modifica-tabellato.component.html'
})
export class SdkModificaTabellatoComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

  // #region Variables

  @HostBinding('class') classNames = `sdk-modifica-tabellato-section`;
  ...
  public onButtonClick(button: SdkButtonGroupOutput): void {
    if (button != null && isEmpty(button.provider) === false) {
      let data: IDictionary<any> = {
        ...
        item2: this.dettaglio
      };

      if (button.code === 'back-to-dettaglio-tabellato' && isEqual(this.defaultFormBuilderConfig, this.formBuilderConfig) === false) {
