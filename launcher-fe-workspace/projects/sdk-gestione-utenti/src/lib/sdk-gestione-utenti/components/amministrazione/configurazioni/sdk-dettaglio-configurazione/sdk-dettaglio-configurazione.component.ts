...
@Component({
  templateUrl: './sdk-dettaglio-configurazione.component.html'
})
export class SdkDettaglioConfigurazioneComponent extends SdkBusinessAbstractWidget<void> implements OnInit, OnDestroy {

  // #region Variables

  @HostBinding('class') classNames = `sdk-dettaglio-configurazione-section`;
