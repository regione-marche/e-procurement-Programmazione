 ...
 */
public class WLogEventiServiceImpl extends WLogEventiServiceBase implements WLogEventiService {

    private static final Logger LOGGER = LoggerFactory.getLogger(WLogEventiServiceImpl.class);
